```
меняем одну букву в имени класса, чтобы блокировщики рекламы не скрывали содержимое этого блока
<div class="footer__soc1al soc1al">
...
.soc1al {
  ...
  &__item {
    display: flex; // чтобы размеры была не больше, чем в макете
  }
